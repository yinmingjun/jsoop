...
var testClass = (function () {
    ...
    function testClass() {
        ...
        unitTestFW.test("testClass-isClass-1", function () { unitTestFW.ok(jsoop.isClass(unitTest.DemoBase), "Passed!"); });
        unitTestFW.test("testClass-isClass-2", function () { unitTestFW.ok(!jsoop.isClass(unitTest.IDemoIntf), "Passed!"); });
        unitTestFW.test("testClass-isClass-3", function () { unitTestFW.ok(!jsoop.isClass(unitTest.DemoMod), "Passed!"); });
        unitTestFW.test("testClass-isClass-4", function () { unitTestFW.ok(!jsoop.isClass(unitTest.DemoEnum), "Passed!"); });
        unitTestFW.test("testClass-isInterface-1", function () { unitTestFW.ok(!jsoop.isInterface(unitTest.DemoBase), "Passed!"); });
        unitTestFW.test("testClass-isInterface-2", function () { unitTestFW.ok(jsoop.isInterface(unitTest.IDemoIntf), "Passed!"); });
        unitTestFW.test("testClass-isInterface-3", function () { unitTestFW.ok(!jsoop.isInterface(unitTest.DemoMod), "Passed!"); });
        unitTestFW.test("testClass-isInterface-4", function () { unitTestFW.ok(!jsoop.isInterface(unitTest.DemoEnum), "Passed!"); });
        unitTestFW.test("testClass-isModule-1", function () { unitTestFW.ok(!jsoop.isModule(unitTest.DemoBase), "Passed!"); });
        unitTestFW.test("testClass-isModule-2", function () { unitTestFW.ok(!jsoop.isModule(unitTest.IDemoIntf), "Passed!"); });
        unitTestFW.test("testClass-isModule-3", function () { unitTestFW.ok(jsoop.isModule(unitTest.DemoMod), "Passed!"); });
        unitTestFW.test("testClass-isModule-4", function () { unitTestFW.ok(!jsoop.isModule(unitTest.DemoEnum), "Passed!"); });
        unitTestFW.test("testClass-isEnum-1", function () { unitTestFW.ok(!jsoop.isEnum(unitTest.DemoBase), "Passed!"); });
        unitTestFW.test("testClass-isEnum-2", function () { unitTestFW.ok(!jsoop.isEnum(unitTest.IDemoIntf), "Passed!"); });
        unitTestFW.test("testClass-isEnum-3", function () { unitTestFW.ok(!jsoop.isEnum(unitTest.DemoMod), "Passed!"); });
        unitTestFW.test("testClass-isEnum-4", function () { unitTestFW.ok(jsoop.isEnum(unitTest.DemoEnum), "Passed!"); });
        //getInstanceType
